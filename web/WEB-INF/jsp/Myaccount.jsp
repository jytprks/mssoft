...
<!--                                <li><a href="Cadd.htm">Change Address</a></li>
                    ...
                    <div class="header_bottom_right">	
                        <div class="contact-form">
                            <div  class="form">
                                <form:form action="updateDetails.htm" method="post" commandName="registrationBean"> 
                                    <p class="contact"><label for="password">First Name</label></p> 
                                    <form:input path="fristName" placeholder="Password" id="password"/> </br> 
                                    <p class="contact"><label for="password">Last Name</label></p> 
                                    <form:input path="lastName" placeholder="Password" id="password"/> </br>
                                    <p class="contact"><label for="password">Address</label></p> 
                                    <form:input path="address" placeholder="Password" id="password"/> </br>
                                    <p class="contact"><label for="password">Pin Code</label></p> 
                                    <form:input path="pinCode" placeholder="Password" id="password"/> </br>
                                    <p class="contact"><label for="password">Mobile phone</label></p> 
                                    <form:input path="mobileNo" placeholder="Password" id="password"/> </br>
                                    <input class="buttom" name="submit" id="submit" tabindex="5" value="Update" type="submit"> 	 
                                    <!--<p class="contact"><label for="password">${success}</label></p>--> 
                                    <p class="contact"><label for="password"><font style="color: greenyellow">${success}</font></label></p>
                                    <p class="contact">
                                        <form:hidden path="emailId" placeholder="Password" id="password"/> </br>
                                        <form:hidden path="name" placeholder="Password" id="password"/> </br>
                                    </p> 
