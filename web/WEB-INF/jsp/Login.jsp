                    ...
                    <div class="section group">
                        <div class="col span_2_of_3">
                            <div class="contact-form">
                                <h2>Contact Us</h2>
                                <div  class="form">
                                    <form:form action="login.htm" method="post"  commandName="LoginDetails">
                                        <!--    		<form id="contactform"> -->
                                        <p class="contact"><label for="name">User Name</label></p>

                                        <input id="name" name="name" placeholder="User name" required="" tabindex="1" type="text"> 


                                        <p class="contact"><label for="password"> password</label></p> 
                                        <input type="password" placeholder="Password" id="password" name="password" required=""> </br>
                                        <input class="buttom" name="submit" id="submit" tabindex="5" value="Log In!" type="submit">
                                        <a href="Forgotpass.htm"><u>forgot password</u></a>
                                        <p>
