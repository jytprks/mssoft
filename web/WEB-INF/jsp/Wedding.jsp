                    ...
                    <div class="header_bottom_left">				
                        <div class="categories">
                            <ul>
                                <h3>Categories</h3>
                                <li><a href="#">ALL</a></li>
                                <li><a href="wedDecoration.htm">DECORATERS</a></li>
                                <li><a href="wedLight.htm">LIGHT</a></li>
                                <li><a href="wedSound.htm">SOUND</a></li>
                                <li><a href="wedBandbaja.htm">BANDBAJA</a></li>
                                <li><a href="wedFood.htm">Food</a></li>
                                <li><a href="wedLodge.htm">Lodge</a></li>
                            </ul>
                        </div>					
                    </div>
            ...
            <div class="wrap">
                <div class="content">
                    ...
                    <div class="section group">
                        <c:forEach items="${wedding}" var="prod">  
                            <div class="grid_1_of_5 images_1_of_5">
                                ...
                                <div class="price-details">
                                    ...
                                    <div class="add-cart">								
                                        <h4><a href="${myURL}">Add to Cart</a></h4>
                                    </div>
                                    <div class="clear"></div>
                                </div>
