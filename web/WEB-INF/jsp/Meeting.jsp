                    ...
                    <div class="header_bottom_left">				
                        <div class="categories">
                            <ul>
                                <h3>Categories</h3>
                                <li><a href="#">ALL</a></li>
                                <li><a href="meetingDecoration.htm">DECORATERS</a></li>
                                <li><a href="meetingLight.htm">LIGHT</a></li>
                                <li><a href="meetingSound.htm">SOUND</a></li>
                                <li><a href="meetingFood.htm">Food</a></li>
                                <li><a href="meetingLodge.htm">Lodge</a></li>
                            </ul>
                        </div>					
                    </div>
            ...
            <div class="wrap">
                <div class="content">
                    ...
                    <div class="section group">
                        <c:forEach items="${meetingList}" var="prod">  
