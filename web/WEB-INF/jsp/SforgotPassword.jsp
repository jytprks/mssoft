                ...
                <div class="content">
                    <div class="content_top">
                        <div class="back-links">
                            <p><a href="home.htm">Home</a> &gt;&gt;&gt;&gt; <a href="#" class="active">Contact</a></p>
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="section group">
                        <div class="col span_2_of_3">
                            <div class="contact-form">
                                <h2>Contact Us</h2>
                                <div  class="form">
                                    <form:form action="Sforgotpass.htm" method="post"  commandName="LoginDetails">
                                        <!--    		<form id="contactform"> -->
                                        <p class="contact"><label for="name">Enter Your Mail Id</label></p>

                                        <input id="name" name="Email" placeholder="Email" required="" tabindex="1" type="text"> 


                                        </br>
                                        <input class="buttom" name="submit" id="submit" tabindex="5" value="GET PASSWORD" type="submit">
                        ...
                        <div class="col span_1_of_3">
                            ...
                            <div class="company_address">
                                ...
                                <p>Email: <span><a href="mailto:info">mail@example.com</a></span></p>
