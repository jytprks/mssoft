...
<!--                                <li><a href="Cadd.htm">Change Address</a></li>
                    ...
                    <div class="header_bottom_right">	
                        <div class="contact-form">
                            <div  class="form">
                                <form:form action="changepassword.htm" method="post">  
                                    <p class="contact"><label for="password">Old Password</label></p> 
                                    <input type="password" placeholder=" Old Password" id="password" name="oldpassword" required=""> </br>
                                    <p class="contact"><label for="password">New Password</label></p> 
                                    <input type="password" placeholder="New Password" id="password" name="newpassword" required=""> </br>
                                    <p class="contact"><label for="password">Confirm Password</label></p> 
                                    <input type="password" placeholder="Confirm Password" id="password" name="confirmpassword" required=""> </br>                                  
                                    <input class="buttom" name="submit" id="submit" tabindex="5" value="Update" type="submit"> 	 
                                    <form:errors path="*" cssStyle="color: greenyellow"/>
