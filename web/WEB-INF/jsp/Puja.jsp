                    ...
                    <div class="header_bottom_left">				
                        <div class="categories">
                            <ul>
                                <h3>Categories</h3>
                                <li><a href="#">ALL</a></li>
                                <li><a href="pujaDecoration.htm">DECORATERS</a></li>
                                <li><a href="pujaLight.htm">LIGHT</a></li>
                                <li><a href="pujaSound.htm">SOUND</a></li>
                                <li><a href="pujaProgram.htm">PROGRAM</a></li>
                                <li><a href="pujaBandbaja.htm">BANDBAJA</a></li>
                                <li><a href="pujaFood.htm">Food</a></li>
                            </ul>
                        </div>					
                    </div>
