                    ...
                    <div class="header_bottom_left">				
                        <div class="categories">
                            <ul>
                                <h3>Categories</h3>
                                <li><a href="#">ALL</a></li>
                                <li><a href="birthDayDecoration.htm">DECORATERS</a></li>
                                <li><a href="birthDayLight.htm">LIGHT</a></li>
                                <li><a href="birthDaySound.htm">SOUND</a></li>
                                <li><a href="birthDayCake.htm">CAKE</a></li>
                                <li><a href="birthDayFood.htm">Food</a></li>
                            </ul>
                        </div>					
                    </div>
            ...
            <div class="wrap">
                <div class="content">
                    ...
                    <div class="section group">
                        <div class="section group">
                            <c:forEach items="${birthDaylist}" var="prod">  
